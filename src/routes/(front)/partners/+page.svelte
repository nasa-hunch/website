...
<div class="getInvolved">
	<div class="item">
		...
		<div class="content">
			...
			<p>Become a HUNCH partner and provide equipment or funding for participating schools and students.</p>
		</div>
	</div>
	<div class="item">
		...
		<div class="content">
			<h2>Mentor a Team</h2>
			<p>Guide high school students as they apply their skills and create exciting projects that may one day reach space.</p>
		</div>
	</div>
	<div class="item">
