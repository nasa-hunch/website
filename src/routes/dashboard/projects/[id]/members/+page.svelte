...
<ModelHelper bind:visible={showingInvite}>
	<ModelForm method="post" action="?/refreshCode">
		<div class="inviteCode">
			<p>Send project invite: </p>
			<span class="projectCode"><input disabled value={data.project.joinCode}> <button type="button" on:click={copyCode}>Copy</button></span>
