...
const deadline = (minMonths = 3, maxMonths = 5) => new Date(Date.now() + random(minMonths * MONTH, maxMonths * MONTH));
        ...
        projectTemplates: {
            create: [
                ...
                },
                {
                    ...
                    description: block(`Develop a Virtual Reality, multi-room, lunar habitat that allows viewers to
